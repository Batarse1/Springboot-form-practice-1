		...
		<form method="post" action="saveDetails">
			<fieldset>
				...
				<label for="studentName">
					<span>Name</span>
					<input type="text" class="input-field" name="studentName"/>
				</label> 
				<label for="studentSurname">
					<span>Surname</span>
					<input type="text" class="input-field" name="studentSurname"/>
				</label>
				<label for="studentCard">
					<span>UCA card name</span>
					<input type="text" class="input-field" name="studentCard">
				</label>
				<label for="birthday">
					<span>Birthday</span>
